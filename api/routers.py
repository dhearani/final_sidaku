...
from .views import BeritaViewSet, FaktaViewSet, ProdukHukumViewSet, RapatKoordinasiViewSet, PaparanViewSet, KoperasiViewSet, UMKMViewSet, LaporanKeuanganViewSet, GambarViewSet, RegisterViewSet, ChangePasswordViewSet
